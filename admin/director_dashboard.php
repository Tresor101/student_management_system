...
<div class="container mt-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            <h1 class="mb-1">Welcome, School Director / Owner</h1>
            <p class="lead text-muted">View school performance, manage finances, and make strategic decisions.</p>
        </div>
        <div class="col-md-4 text-end d-none d-md-block">
            <img src="https://img.icons8.com/color/96/businessman.png" alt="Director Icon" style="height:72px;">
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body d-flex flex-wrap gap-2">
                    <a href="#" class="btn btn-outline-warning flex-fill">View Financials</a>
                    <a href="#" class="btn btn-outline-success flex-fill">Manage Budgets</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-info text-white">Strategic Decisions</div>
                <div class="card-body d-flex flex-wrap gap-2">
                    <a href="#" class="btn btn-outline-info flex-fill">Approve Policies</a>
                    <a href="#" class="btn btn-outline-dark flex-fill">School Growth</a>
                </div>
            </div>
        </div>
    </div>
