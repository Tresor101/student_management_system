...
<div class="container mt-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            <h1 class="mb-1">Welcome, Vice Principal</h1>
            <p class="lead text-muted">Assist the principal, monitor attendance, and handle student/staff issues.</p>
        </div>
        <div class="col-md-4 text-end d-none d-md-block">
            <img src="https://img.icons8.com/color/96/assistant.png" alt="Vice Principal Icon" style="height:72px;">
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-primary text-white">Monitor & Support</div>
                <div class="card-body d-flex flex-wrap gap-2">
                    <a href="#" class="btn btn-outline-primary flex-fill">Monitor Attendance</a>
                    <a href="#" class="btn btn-outline-success flex-fill">Assist with Discipline</a>
                    <a href="#" class="btn btn-outline-info flex-fill">Report to Principal</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
